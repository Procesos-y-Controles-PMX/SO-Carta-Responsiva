...
export const CARTA_INTRO_TEMPLATE = (
  ...
  `Yo, ${nombreResponsable.toUpperCase()}, como parte del equipo de la sucursal ${codigoSucursal}, hago constar que he recibido material de la empresa Proveedora Mexicana de Materiales los productos específicos de la presente carta.`;
